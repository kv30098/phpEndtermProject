                    ...
                    <form class="form row">    
                        ...
                        <div class="ratio-group col-12">
                            <div class="ratio-option">
                                <input type="radio" class="ratio" name="sexual" id="male" value="male">
                                <label class="bt male" for="male"><span class="tag">A</span><span class="cc">男生</span></label>
                            </div>
                            <div class="ratio-option">
                                <input type="radio" class="ratio" name="sexual" id="female" value="femal">
                                ...
                                <div class="select-content">
                                    <div class="select-option">
                                        ...
                                        <select class="form-select" name="dislike[]" multiple>
                                            ...
                                            <option value="b2">蔬菜番茄筆尖面</option>
                        ...
                        <div class="select-group6 col-12">
                            <div class="select col-6">
                                ...
                                <div class="select-content">
                                    <div class="select-option">
                                        <ul class="options">
                                            <li data-value="c1">鐵觀音黑岩泡芙</li>
                                            <li data-value="c2">烤蔬菜番茄筆尖面</li>
                                            <li data-value="c3">三重起司貝果</li>
                                            <li data-value="c4">日式豬排佐咖哩歐姆蛋燴飯</li>
                                            <li data-value="c5">打拋風植蔬餐盒</li>
                                        </ul>
                                        <select class="form-select" name="favorate[]" multiple>
                                            <option value="c1">鐵觀音黑岩泡芙</option>
                                            <option value="c2">蔬菜番茄筆尖面</option>
                                            <option value="c3">三重起司貝果</option>
                                            <option value="c4">日式豬排佐咖哩歐姆蛋燴飯</option>
                                            <option value="c5">打拋風植蔬餐盒</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
